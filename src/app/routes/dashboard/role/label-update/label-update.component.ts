...
import { QuestionTypeOptionsObject, UpdateLabelQuestionRequestParams } from '@shared/interface/role';
...
export class LabelUpdateComponent implements OnInit {
  ...
  submit(): void {
    ...
    this.roleService.updateLabelQuestion(this.question_id, params).subscribe(
